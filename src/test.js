...
function App() {
  ...
  const [layers, setLayers] = useState({
    roads: { visible: true, name: "Roads" },
    buildings: { visible: true, name: "Buildings" },
    parcels: { visible: false, name: "Parcels" },
    waterBodies: { visible: true, name: "Water Bodies" },
    parks: { visible: true, name: "Parks" },
  });
            ...
            <Box sx={{ flex: 1, overflow: "auto" }}>
              <List dense>
                ...
                >
                  ...
                  <LayersIcon sx={{ mr: 1, fontSize: 20, color: "#1976d2" }} />
                  <ListItemText
                    primary="Assets"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <LayersIcon sx={{ color: "#1976d2", fontSize: 16 }} />
                  </IconButton>
                  <Typography variant="caption" sx={{ fontSize: "10px" }}>
                    All Markup
                  </Typography>
                ...
                >
                  ...
                  >
                    <SettingsIcon sx={{ color: "#1976d2", fontSize: 16 }} />
                  </IconButton>
                  <Typography variant="caption" sx={{ fontSize: "10px" }}>
                    Buffer
                  </Typography>
